...
// For development purposes, we'll use a mock API that returns the data directly
// In a real application, you would fetch from JSON Server or a backend API
export const fetchQuizData = async (): Promise<QuizData> => {
  // This would be a real API call in production
  // return await fetch('http://localhost:3000/quizData').then(res => res.json());
